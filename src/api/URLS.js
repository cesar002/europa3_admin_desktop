...
export const REGISTER_USER_ADMIN = '/register/admin';
...
export const GET_ADICIONALES = '/adicionales';
export const REGISTER_ADICIONAL = '/adicional';
export const UPDATE_ADICIONAL = '/adicional';
