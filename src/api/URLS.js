...
export const GET_CHATS = '/chat/chats/solicitudes';
export const SEND_MESSAGE_CHAT = '/chat/recepcion/edificio';
export const GET_OFICINAS_VIRTUALES = '/oficinas-virtuales';
export const GET_OFICINA_VIRTUAL_BY_ID = '/oficina-virtual';
export const REGISTER_OFICINAS_VIRTUALES = '/oficina-virtual';
export const UPDATE_OFICINA_VIRTUAL = '/oficina-virtual';
export const DELETE_OFICINA_VIRTUAL = '/oficina-virtual';
